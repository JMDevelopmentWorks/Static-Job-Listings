      ...
      {filters.length > 0 && (
        <div className="flex -mt-24  items-center justify-between  relative bg-white m-4 p-6 lg:py-6 lg:px-12 rounded shadow-card">
            ...
            {filters.map((filter, index) => (
              <div className="bg-backgroundCyan text-desaturatedCyan font-bold tracking-tight text-appBase pl-2 my-1 rounded-md flex  gap-2 relative ">
                ...
                <span
                  ...
                  key={index}
                  className="bg-desaturatedCyan hover:bg-veryDarkCyan hover:cursor-pointer text-white w-7 rounded-r text-center py-1"
                >
                  ✕
                </span>
              </div>
          ...
          <span
            ...
            className="text-appBase font-bold text-gray-400 hover:underline hover:text-desaturatedCyan hover:cursor-pointer"
          >
            Clear
          </span>
        </div>
