  ...
  return (
    ...
    >
      <div className="lg:flex lg:gap-10 lg:items-center">
        ...
        <div className="flex flex-col gap-3.5 font-bold -ml-5 lg:ml-0 ">
          ...
          <h2 className="text-base tracking-tight font-bold"> {job.position} </h2>
      ...
      <div className="lg:hidden h-0.5 w-30 bg-gray-200 -ml-5 mt-6 mb-6"></div>
      <div className="flex flex-wrap justify-start lg:justify-end lg:ml-auto gap-4 items-center -ml-5 font-bold text-appBase text-desaturatedCyan ">
